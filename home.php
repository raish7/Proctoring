...
<body>
  <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="home.html" style="font-family: Poppins;font-size:20px;">Parikshya</a>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4"><br>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <center><img src="icons/test-passed.png" height="auto" width="60%"><br>
            <br>
            <f style="font-family: Roboto; letter-spacing: 1px; font-size: 20px;"><b>Computer</b></f><br><br>
            <button type="button" class="btn btn-info" onclick="window.location.href='compexam.php';">View
              Details</button>
          </center>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <img src="icons/lamp.png" height="auto" width="100%"><br><br>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <img src="icons/extra-person.png" height="auto" width="100%"><br><br>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <img src="icons/camera-focus.png" height="auto" width="100%"><br><br>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <img src="icons/reg3.png" height="auto" width="100%"><br><br>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <img src="icons/ontest2.jpg" height="auto" width="100%"><br><br>
          <f style="font-family: Roboto;font-size: 1.2em;"> <b>Register for the Exam</b><br>
            Register for the Exam you want to Appear. You can Register in single click for the Exam of your Choice
            from Dashboard</f>
        </div>
